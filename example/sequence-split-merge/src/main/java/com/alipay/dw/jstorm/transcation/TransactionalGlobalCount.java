	...
	public static Logger LOG = LoggerFactory.getLogger(TransactionalGlobalCount.class);
	 ...
	 public static final int PARTITION_TAKE_PER_BATCH = 3;
	  public static final Map<Integer, List<List<Object>>> DATA = new HashMap<Integer, List<List<Object>>>() {/**
		 * 
		 */
		private static final long serialVersionUID = -4154141996859532736L;

	{
			put(0, new ArrayList<List<Object>>() {/**
			 * 
			 */
			private static final long serialVersionUID = -1275585887518175360L;
	    ...
	    put(1, new ArrayList<List<Object>>() {/**
			 * 
			 */
			private static final long serialVersionUID = 4894965590477076419L;
	    ...
	    put(2, new ArrayList<List<Object>>() {/**
			 * 
			 */
			private static final long serialVersionUID = -5904964152413088944L;
	  ...
	  public static class BatchCount extends BaseBatchBolt<Object> {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 7402330267729702876L;
		Object _id;
	  ...
	  public static class UpdateGlobalCount extends BaseTransactionalBolt implements ICommitter {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 7637574482040790626L;
