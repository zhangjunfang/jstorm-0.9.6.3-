...
public class TridentTopology {
    ...
    //: add a method for drpc stream, needs to know how to automatically do returnresults, etc
...
//    }
    ...
    public StormTopology build() {
        ...
        // : in the future, want a way to include this logic in the spout itself,
        ...
        for(SpoutNode sn: spoutNodes) {
            ...
            if(sn.type == SpoutNode.SpoutType.DRPC) {
                ...
                if(sn.spout instanceof IBatchSpout) {
                    ...
                    // : handle regular rich spout without batches (need lots of updates to support this throughout)
                }
