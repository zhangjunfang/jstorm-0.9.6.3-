...
public class TridentBoltExecutor implements IRichBolt {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7240762372125476872L;
    ...
    public static class CoordType implements Serializable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 3873101648124140591L;
    ...
    public static class CoordSpec implements Serializable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 6210676299453151431L;
    ...
    public static class CoordCondition implements Serializable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 4576637692739239907L;
    ...
    private void checkFinish(TrackedBatch tracked, Tuple tuple, TupleType type) {
        ...
        if(tracked.receivedCommit && tracked.reportedTasks == cond.expectedTaskReports) {
            if(tracked.receivedTuples == tracked.expectedTupleCount) {
                ...
                //: add logging that not all tuples were received
                failBatch(tracked);
                _collector.fail(tuple);
                failed = true;
            }
...
//        }
    ...
    public Map<String, Object> getComponentConfiguration() {
        ...
        // : Need to be able to set the tick tuple time to the message timeout, ideally without parameterization
        return ret;
    }
