...
public class TridentTupleView extends AbstractList<Object> implements TridentTuple {
    ...
    public static class ProjectionFactory implements Factory {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 2804109286492018030L;
		Map<String, ValuePointer> _fieldIndex;
        ValuePointer[] _index;
        Factory _parent;
    ...
    public static class FreshOutputFactory  implements Factory {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 7065188014779837054L;
		Map<String, ValuePointer> _fieldIndex;
        ValuePointer[] _index;
    ...
    public static class OperationOutputFactory implements Factory {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 1249603354130496568L;
		Map<String, ValuePointer> _fieldIndex;
        ValuePointer[] _index;
        Factory _parent;
    ...
    public static class RootFactory implements Factory {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -5255004184549188039L;
		ValuePointer[] index;
