...
// : parameterizing it like this with everything might be a high deserialization cost if there's lots of tasks?
// : memory problems?
// : can avoid these problems by adding a boltfactory abstraction, so that boltfactory is deserialized once
...
public class SubtopologyBolt implements ITridentBatchBolt {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4514583234690743259L;
    ...
    public void prepare(Map conf, TopologyContext context, BatchOutputCollector batchCollector) {
        ...
        // : get prepared one time into executor data... need to avoid the ser/deser
    ...
    protected class InitialReceiver {
        ...
        public InitialReceiver(String stream, Fields allFields) {
            // : don't want to project for non-batch bolts...???
